        ...
        {slug === "contact" && (
          ...
          >
            <div style={{ marginBottom: "20px" }}>
              ...
              <input type="text" name="name" required placeholder="John Doe" style={{ width: "100%", padding: "12px", borderRadius: "8px", border: "1px solid var(--border)", background: "var(--page-bg)", color: "var(--ink)", outline: "none" }} />
            </div>
            <div style={{ marginBottom: "20px" }}>
              <label style={{ display: "block", marginBottom: "8px", fontWeight: 600, color: "var(--ink)", fontSize: "0.9rem" }}>Email</label>
              <input type="email" name="email" required placeholder="john@example.com" style={{ width: "100%", padding: "12px", borderRadius: "8px", border: "1px solid var(--border)", background: "var(--page-bg)", color: "var(--ink)", outline: "none" }} />
            </div>
            <div style={{ marginBottom: "24px" }}>
